...
class OptimizerFactory
{
    ...
    protected function setUpOptimizers(): void
    {
        ...
        $this->optimizers['jpegoptim_95'] = $this->wrap(
            $this->commandOptimizer('jpegoptim', $this->options['jpegoptim_options95'])//add by charlizesmith
        );
        $this->optimizers['jpegoptim_90'] = $this->wrap(
            $this->commandOptimizer('jpegoptim', $this->options['jpegoptim_options90'])//add by charlizesmith
        );
        $this->optimizers['jpegoptim_80'] = $this->wrap(
            $this->commandOptimizer('jpegoptim', $this->options['jpegoptim_options80'])//add by charlizesmith
        );
        $this->optimizers['jpegoptim_70'] = $this->wrap(
            $this->commandOptimizer('jpegoptim', $this->options['jpegoptim_options70'])//add by charlizesmith
        );
